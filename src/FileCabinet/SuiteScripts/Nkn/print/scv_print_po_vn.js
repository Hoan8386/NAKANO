...
define([
    ...
    '../cons/scv_cons_search_print_po_vn_01.js',
], (
        record, url, runtime,
        libPdf,
        ...
        const addBtnPrint = (scriptContext, curRec) => {
            ...
            let urlScript = url.resolveScript({
                ...
                params: {
                    ...
                    printFile: "scv_print_po_vn",
                }
            });

            form.addButton({
                id: "custpage_scv_btn_print_po_vn_pdf",
                label: "PO (VN)",
        ...
        const generateFilePDF = (_params) => {
            commonExtPerformance.startTime("scv_print_po_vn");
            ...
            commonExtPerformance.endTime("scv_print_po_vn");
        ...
        const rennderPDF = (curRec) =>{
            ...
            const renderer = libPdf.renderTemplateWithXml("scv_print_po_vn");
