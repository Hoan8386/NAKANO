    ...
    (cache, config, format, message, record, redirect, runtime, search, serverWidget, task, libRep) => {
        ...
        const onRequest = (context) => {
            ...
            if (request.method === 'GET') {
                let title = 'Custom Allocation';
                let form = serverWidget.createForm({
                    title: title
                });
                form.clientScriptModulePath = '../cssl/scv_cs_sl_allocation_fs.js';
                ...
                if (isRun) {
                    ...
                    try {
                        ...
                        let mrTask = task.create({
                            ...
                            scriptId: 'customscript_scv_mr_allocation_fs',
                            deploymentId: 'customdeploy_scv_mr_allocation_fs'
                        });
                        mrTask.params = {
                            custscript_scv_mr_altemplate: template.toString(),
                            custscript_scv_mr_year_month: year_month.toString(),
                            custscript_scv_mr_timezone: timezone.toString(),
                            custscript_scv_mr_trandate: trandate.toString(),
                            custscript_scv_mr_ordertype: ordertype,
                            custscript_scv_mr_memo: memo,
                            custscript_scv_mr_fs_subsidiary: subsidiary.toString()
                        };
                ...
                redirect.toSuitelet({
                    scriptId: 'customscript_scv_sl_allocation_fs',
                    deploymentId: 'customdeploy_scv_sl_allocation_fs',
        ...
        const addFieldSearch = (form, template, trandate, subsidiary) => {
            ...
            libRep.addSearch('customrecord_scv_altem', ['name'], [['custrecord_scv_allocation_type', 'anyof', 1]], template, fTemplate, false);
