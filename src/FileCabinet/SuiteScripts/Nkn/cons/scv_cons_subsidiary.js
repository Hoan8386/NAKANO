    ...
    (record, search, query, runtime,
        ...
        const getDataSubsidiaryByUserRole = () => {
            ...
            switch (subsidiary_op){
                case SubsidiaryOption.ALL.ID:
                    myFilter = [];
                    break;
                case SubsidiaryOption.ALLACTIVE.ID:
                    myFilter = [['isinactive', 'is', false]];
                    break;
                case SubsidiaryOption.OWN.ID:
                    ...
                    break;
                case SubsidiaryOption.SELECTED.ID:
